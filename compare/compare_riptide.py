...
def main(argv=None):
    ...
    print()
    print("  Both sides peak the same zero-mean unit-L2 boxcar matched filter")
    print("  (riptide cpp/snr.hpp:snr1).  As of 2026-08-28 ours additionally divides")
    print("  by the exact noise of ITS OWN fold: our profile is a band-limited")
    print("  Fourier fold, so its phase bins are correlated and snr1's sqrt(w(1-d))")
    print("  is the wrong scale (riptide's time-domain bins ARE independent, so it")
    print("  is right for riptide).  On a fully-sampled profile that is a factor")
    print("  1 + 3/(4*nbins); past a Nyquist knee it was worth up to ~2.5x.  So a")
    print("  residual S/N gap is a statement about the folds, not the detector.")
    print("  Duty cycles are defined identically on both sides.")
